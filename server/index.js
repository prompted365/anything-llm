...
const { orchestratorEndpoints } = require("./endpoints/orchestrator");
...
if (!!process.env.ENABLE_HTTPS) {
  bootSSL(app, process.env.PORT || process.env.SERVER_PORT || 3001);
} else {
...
utilEndpoints(apiRouter);
  ...
  orchestratorEndpoints(apiRouter);
...
if (!process.env.ENABLE_HTTPS) bootHTTP(app, process.env.PORT || process.env.SERVER_PORT || 3001);
